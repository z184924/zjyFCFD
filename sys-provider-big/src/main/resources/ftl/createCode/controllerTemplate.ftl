package com.wxmetro.controller.${packageName};
...
import com.wxmetro.controller.base.BaseController;
import com.wxmetro.entity.Page;
import com.wxmetro.util.AppUtil;
import com.wxmetro.util.ObjectExcelView;
import com.wxmetro.util.PageData;
import com.wxmetro.service.${packageName}.${objectName}Service;
